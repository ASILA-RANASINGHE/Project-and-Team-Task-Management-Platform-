            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-lg border border-white/10 bg-white/[0.05] px-4 py-2.5 pr-10 text-sm text-white placeholder-slate-500 outline-none ring-sky-500/40 transition-all duration-200 focus:border-sky-500/50 focus:bg-white/[0.08] focus:ring-2"
                />
                <button
                  type="button"
